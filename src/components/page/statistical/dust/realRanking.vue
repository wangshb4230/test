            ...
            <div class="panel-bd" >
                <div>
                        ...
                        <el-form  :inline="true">
                            ...
                            <el-form-item style="margin-left: 5px ;"  >
                                <el-radio-group v-model="paramId" size="medium">
                                    <el-radio-button label="tsp" key="tsp">TSP</el-radio-button>
                                    <el-radio-button label="PM10" key="pm10">PM10</el-radio-button>
                                    <el-radio-button label="PM2.5" key="pm25">PM2.5</el-radio-button>
                                </el-radio-group>
                            </el-form-item>
                   ...
                   <!-- <div class="">
                        ...
                        <div id="realRanking" style="width: 100%;height: 500px;"></div>
                    </div>
            </div>
        </div>
        ...
        methods:{
            ...
            realRanking(dataX,dataY){
                ...
                var chart = echarts.init(
                    document.getElementById("realRanking"),
                    "skinUpp"
                );
