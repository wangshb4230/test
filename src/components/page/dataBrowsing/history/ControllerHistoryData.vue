...
<script>
    ...
    export default {
        name: "controllerHistoryData",
        components: {
            Pagination
        },
        data() {
            return {
                controllerHistoryData: [],
                formInline: {
                    sortType: '2',
                },
        ...
        methods: {
            ...
            onSubmit() {
                ...
                this.ajaxUtil.sendGet(this.AppConfig.gkzApi + "/dataview/r/getStaByPeriod", params).then(function (data) {
                    console.log(params)
                    // console.log(data)
                    _self.controllerHistoryData = data.data.data
                    console.log(_self.controllerHistoryData)
