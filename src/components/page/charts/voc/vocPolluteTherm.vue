    ...
    <div class="main">
        <div class="main-top">
            <div class="breadcrumb">
                ...
                <span class="sep">&gt;</span><span class="text-primary">VOC检测</span>
        ...
        <div class="panel">
            ...
            <div style="float: right">
                <el-button-group>
                    ...
                    <el-button type="primary" @click="factorChange('tvoc')">TVOC</el-button>
                    <el-button type="primary" @click="factorChange('nh3')">NH₃</el-button>
                    <el-button type="primary" @click="factorChange('h2s')">H₂S</el-button>
                </el-button-group>
            </div>
